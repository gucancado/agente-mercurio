...
Tratamento de objeções em 3 movimentos: **reconhecer → reenquadrar → próximo passo pequeno**.

Regra de ouro: NUNCA insistir mais de 2 vezes na mesma objeção.

## Catálogo de objeções

| Objeção do lead | Resposta padrão |
|---|---|
| "Estou sem tempo" | "Sem problema. Quer que eu te chame em outro momento? Manhã ou tarde funciona melhor para você?" |
| "Manda por email/material" | "Material genérico vai dizer pouco. Rende mais uma call de 20 min onde entendo seu cenário. Tenho [op1] ou [op2], dá?" |
...
- Lead responde com 1 palavra ("não", "obrigado", "tchau").
- Lead diz "sem chance", "não tenho interesse mesmo".
- 2ª tentativa na mesma objeção falhou.

Nesses casos: encerrar com classe + nutrição.

> "Sem problema. Obrigada pela conversa. Qualquer coisa, sabe onde me achar 👍"

## NUNCA fazer

- ❌ Discutir com o lead ("mas não, você está errado...").
- ❌ Pressão de escassez falsa.
- ❌ Insistir 3+ vezes na mesma objeção.
- ❌ Chantagem emocional ("vai perder a oportunidade").
- ❌ Falar mal de concorrente ou agência atual do lead.
- ❌ Prometer resultado específico para destravar a objeção.
